...
func run() error {
	...
	go func() {
		if err := client.Receive(ctx, emailSub, func(ctx context.Context, payload *models.EmailPayload) error {
			return handlers.HandleEmailMessage(ctx, payload, emailService)
		}); err != nil {
	...
	go func() {
		if err := client.ReceiveVerification(ctx, verificationSub, handlers.HandleVerificationMessage); err != nil {
	...
	go func() {
		if err := client.ReceiveUser(ctx, userSub, func(ctx context.Context, payload *models.UserPayload) error {
			return handlers.HandleUserMessage(ctx, payload, emailService)
		}); err != nil {
